...
Since Pepito Cleaner seems to be no longer maintained, the developers are not identifiable, and the license terms of the software are unknown, I have programmed the extension  _poemenia_, which helps to localize a Pepito Cleaner installation from the outside. Currently the  _de-DE_  option is available, suitable for Germany and Austria.

For more information and German translation, see the [project home page (German)](https://peter88213.github.io/poemenia/) with description and download instructions.
